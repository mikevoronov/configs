...
set -U fish_user_paths ~/.cargo/bin /usr/local/sbin /usr/local/bin /usr/bin /bin
...
setenv OS_USERNAME voronovm 
setenv OS_TENANT_NAME voronovm_tenant
...
function fish_greeting
	echo
	echo -e (uname -a | awk '{print " \\\\e[1mOS: \\\\e[0;32m"$0"\\\\e[0m"}')
